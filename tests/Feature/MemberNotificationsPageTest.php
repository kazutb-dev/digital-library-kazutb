...
class MemberNotificationsPageTest extends TestCase
{
    ...
    public function test_student_can_view_notifications(): void
    {
        ...
        $response->assertSee('Reservation ready for pickup', false);
        $response->assertSee('Digital access granted', false);
    }

    public function test_teacher_can_view_notifications(): void
    {
