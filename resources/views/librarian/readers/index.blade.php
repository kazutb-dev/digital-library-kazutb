...
<div class="mx-auto max-w-7xl space-y-7" data-reader-directory>
    ...
    <section class="rounded-2xl bg-white p-6 shadow-sm"><h2 class="font-headline text-2xl">{{ $c['directory'] }}</h2>
        ...
        <div class="mt-4 overflow-x-auto"><table class="w-full text-left text-sm"><thead><tr class="border-b"><th class="p-3">{{ __('common.fields.name') }}</th><th class="p-3">{{ $c['login'] }}</th><th class="p-3">{{ $c['email'] }}</th><th class="p-3">{{ $c['status'] }}</th><th class="p-3">{{ $c['category'] }}</th><th></th></tr></thead><tbody>
