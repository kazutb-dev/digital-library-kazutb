...
<div class="mx-auto max-w-3xl space-y-6">
  <header><p class="text-sm font-bold uppercase tracking-[.2em] text-secondary">KazUTB</p><h1 class="mt-2 font-headline text-4xl text-primary">{{ __('librarian.member_portal.card.title') }}</h1><p class="mt-2 text-slate-600">{{ __('librarian.member_portal.card.instructions') }}</p></header>
