...
@section('title', 'Сервисы библиотеки — Научная библиотека')
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        <div class="feature-card">
          ...
          <p>Поиск по записям каталога с фильтрацией по языку, году издания и наличию экземпляров.</p>
        </div>
        ...
        <div class="feature-card">
          ...
          <p>Срок возврата отображается в личном кабинете. Возможность продления конкретной выдачи уточняйте в библиотеке.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="feature-grid services-centered-grid">
        ...
        <div class="feature-card">
          ...
          <p>Актуальный перечень опубликованных библиотекой внешних ресурсов доступен на странице <a href="/resources">электронных ресурсов</a>.</p>
        </div>

        <div class="feature-card">
          <div class="icon">📖</div>
          <h3>Условия доступа</h3>
          <p>Способ доступа и ограничения, если они указаны библиотекой, приведены в карточке каждого опубликованного ресурса.</p>
        </div>
      </div>
    </div>
  </section>
