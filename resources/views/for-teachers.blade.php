      ...
      <div class="action-groups">
        ...
        <div class="action-group">
          ...
          <div class="action-links">
            ...
            <a href="/catalog" class="btn btn-ghost">По направлениям</a>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="syllabus-steps">
        <div class="step-card">
          ...
          <p>Сформулируйте перечень тем и направлений дисциплины. Используйте <a href="/catalog">тематический поиск</a> для навигации по областям знаний. Определите, какие виды литературы нужны: учебники, монографии, справочные издания, научные журналы.</p>
        </div>
